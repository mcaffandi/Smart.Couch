    ...
    <div className="animate-fade-in">
      ...
      <div className="pace-grid" style={{ marginBottom: 20 }}>
        <div className="pace-card" style={{ background: 'rgba(251,113,133,0.07)', border: '1px solid rgba(251,113,133,0.2)' }}>
          ...
          {age && <div style={{ fontSize: 11, color: '#fb7185', marginTop: 4, fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}><EcgHeartIcon /> {getHRForZone(0.8, 0.9)}</div>}
        </div>
        <div className="pace-card" style={{ background: 'rgba(56,189,248,0.07)', border: '1px solid rgba(56,189,248,0.2)' }}>
          ...
          <div className="pace-unit">min/km</div>
          {age && <div style={{ fontSize: 11, color: '#38bdf8', marginTop: 4, fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}><EcgHeartIcon /> {getHRForZone(0.7, 0.8)}</div>}
        </div>
        <div className="pace-card" style={{ background: 'rgba(52,211,153,0.07)', border: '1px solid rgba(52,211,153,0.2)' }}>
          ...
          <div className="pace-unit">min/km</div>
          {age && <div style={{ fontSize: 11, color: '#34d399', marginTop: 4, fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}><EcgHeartIcon /> {getHRForZone(0.6, 0.7)}</div>}
        </div>
      </div>
