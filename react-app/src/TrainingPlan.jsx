  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="pace-grid" style={{ marginBottom: 20 }}>
        <div className="pace-card" style={{ background: 'color-mix(in srgb, var(--accent-rose) 8%, var(--bg-card))', border: '1px solid color-mix(in srgb, var(--accent-rose) 25%, var(--border))', borderRadius: 16, padding: '16px', display: 'flex', flexDirection: 'column', textAlign: 'left', alignItems: 'flex-start' }}>
          <div style={{ color: 'var(--accent-rose)', fontSize: 11, fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: 8 }}>{lang === 'id' ? 'Ngepush' : 'Push'}</div>
          <div style={{ fontSize: '24px', fontWeight: 700, color: 'var(--text-primary)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: 2 }}>{paces.ngepush}</div>
          <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>min/km</div>
          {age && <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 12, padding: '4px 10px', background: 'var(--bg-card)', border: '1px solid color-mix(in srgb, var(--accent-rose) 20%, var(--border))', borderRadius: 12 }}>HR {getHRForZone(0.8, 0.9)}</div>}
        </div>
        <div className="pace-card" style={{ background: 'color-mix(in srgb, var(--accent-amber) 8%, var(--bg-card))', border: '1px solid color-mix(in srgb, var(--accent-amber) 25%, var(--border))', borderRadius: 16, padding: '16px', display: 'flex', flexDirection: 'column', textAlign: 'left', alignItems: 'flex-start' }}>
          <div style={{ color: 'var(--accent-amber)', fontSize: 11, fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: 8 }}>{lang === 'id' ? 'Sedang' : 'Moderate'}</div>
          <div style={{ fontSize: '24px', fontWeight: 700, color: 'var(--text-primary)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: 2 }}>{paces.sedang}</div>
          <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>min/km</div>
          {age && <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 12, padding: '4px 10px', background: 'var(--bg-card)', border: '1px solid color-mix(in srgb, var(--accent-amber) 20%, var(--border))', borderRadius: 12 }}>HR {getHRForZone(0.7, 0.8)}</div>}
        </div>
        <div className="pace-card" style={{ background: 'color-mix(in srgb, var(--accent-emerald) 8%, var(--bg-card))', border: '1px solid color-mix(in srgb, var(--accent-emerald) 25%, var(--border))', borderRadius: 16, padding: '16px', display: 'flex', flexDirection: 'column', textAlign: 'left', alignItems: 'flex-start' }}>
          <div style={{ color: 'var(--accent-emerald)', fontSize: 11, fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: 8 }}>{lang === 'id' ? 'Santai' : 'Easy'}</div>
          <div style={{ fontSize: '24px', fontWeight: 700, color: 'var(--text-primary)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: 2 }}>{paces.santai}</div>
          <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>min/km</div>
          {age && <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 12, padding: '4px 10px', background: 'var(--bg-card)', border: '1px solid color-mix(in srgb, var(--accent-emerald) 20%, var(--border))', borderRadius: 12 }}>HR {getHRForZone(0.6, 0.7)}</div>}
        </div>
      </div>
                             ...
                             {dItem.hasRun && dItem.actObjs && dItem.actObjs.length > 0 ? (
                               <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                 {dItem.actObjs.slice(0, 2).map((act, actIdx) => (
                                   <div key={actIdx} style={{ display: 'flex', flexDirection: 'column' }}>
