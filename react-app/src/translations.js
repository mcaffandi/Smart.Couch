export const translations = {
  id: {
    ...
    heroTitleLine1: "Buka potensi lari",
    heroTitleLine2: "terbaik lo",
    syncsWithDevices: "Sinkronisasi Otomatis Dengan Jam Lari & Aplikasi Lo",
    heroSubtitle: "Hubungkan data lari dari smartwatch apa pun (Garmin, Coros, Suunto, Apple) atau Strava, dan biarkan AI kami merancang jadwal latihan personal berdasarkan kualitas tidur, pemulihan, serta target performa lo.",
    ...
    run: "Lari",
    sleep: "Tidur",
    smarterTraining: "Latihan Lebih Pintar, Hasil Lebih Cepat",
    bentoSubtitle: "Alat bantu lengkap yang dirancang khusus untuk pelari yang menginginkan rencana berbasis data tanpa ribet.",
    unifiedImportTitle: "Impor Data Terpadu",
    unifiedImportDesc: "Tarik dan lepaskan file ZIP dari Garmin Connect, file GPX dari Strava, atau template Excel/CSV latihan kustom. Menyusun riwayat latihan tanpa API rumit.",
    ...
    adaptiveCalendarTitle: "Kalender Latihan Adaptif",
    adaptiveCalendarDesc: "Jadwal latihan yang fleksibel sesuai waktu luang. Pilih hari lari, tentukan gaya program (ngepush, sedang, santai), dan lihat target pace lo menyesuaikan dinamis.",
    sleepCorrelationTitle: "AI Pemulihan & Korelasi Tidur",
    sleepCorrelationDesc: "Tidak hanya memantau jarak lari. AI kami memetakan hubungan antara skor tidur lo dan zona detak jantung untuk mencegah cedera.",
  ...
  en: {
    ...
    heroTitleLine1: "Unlock your true",
    heroTitleLine2: "running potential",
    syncsWithDevices: "Syncs Seamlessly With Your Sports Watch & Apps",
    heroSubtitle: "Connect your run data from any smartwatch (Garmin, Coros, Suunto, Apple) or Strava, and let our AI design a personalized training plan based on your sleep quality, recovery, and performance goals.",
    ...
    run: "Run",
    sleep: "Sleep",
    smarterTraining: "Smarter Training, Faster Results",
    bentoSubtitle: "A comprehensive tool built specifically for runners who want data-driven plans without the clutter.",
    unifiedImportTitle: "Unified Data Import",
    unifiedImportDesc: "Drag and drop ZIP exports from Garmin Connect, standard GPX files from Strava, or custom Excel/CSV training templates. Conforming your training history without complex APIs.",
    ...
    adaptiveCalendarTitle: "Adaptive Training Calendar",
    adaptiveCalendarDesc: "Generate highly tailored training schedules that fit your schedule. Choose which days to run, select your program style (intensive, moderate, or light), and watch your target paces adjust dynamically.",
    sleepCorrelationTitle: "AI Recovery & Sleep Correlation",
    sleepCorrelationDesc: "We don't just look at mileage. Our AI maps the relationship between your sleep scores and your heart rate zones to prevent overtraining and optimize recovery.",
